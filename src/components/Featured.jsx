  ...
  return (
    <div  className='w-full py-20'>
       <div  className="w-full px-20 border-b-[1px] border-zinc-700 pb-20">
        <h1 className='text-8xl font-["Neue_Montreal"] tracking-tight'>About Us</h1>
       </div>
       <div className="px-20">
        <div className="cards w-full flex gap-10 mt-10">
            ...
            className="cardContainer relative w-[50%] h-[75vh] ">
                <h1 className='absolute flex text-black overflow-hidden left-full -translate-x-1/2 top-1/2 -translate-y-1/2 leading-non tracking-tighter font-bold z-[9] text-9xl'>
                {"REMOVE".split("").map((item, index) => (
                    <motion.span 
                    initial={{y:"100%"}}
                ...
                <div className='w-full h-full rounded-xl overflow-hidden'>
                    <img className='w-full h-full bg-cover' src={img2} alt=""/>
                </div> 
            </motion.div>
            ...
            className="cardContainer relative w-1/2 h-[75vh] ">
                <h1 className='absolute flex overflow-hidden text-black right-full translate-x-1/2 top-1/2 -translate-y-1/2 leading-non tracking-tighter z-[9] font-bold text-9xl'>
                    {"POLUTION".split("").map((item, index) => (
                        <motion.span 
                        initial={{y:"100%"}}
